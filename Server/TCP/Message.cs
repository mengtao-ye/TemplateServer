...
namespace YSF
{
    ...
    {
        public const int MAX_SIZE = 1024 * 1024 * 100;//读取的信息最大缓存量 100M
        ...
        public void Read(int size, Action<short, short,byte[]> callback)
        {
            ...
            while (recordIndex < mIndex)
            {
                ...
                callback((short)((actionCode / CommonConstData.REQUESTCODE_SPAN) * CommonConstData.REQUESTCODE_SPAN), actionCode, mTempBytes);
