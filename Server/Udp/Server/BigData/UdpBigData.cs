...
namespace YSF
{
    public class UdpBigData : IPool
    {
        public short udpCode { get; private set; }
        ...
        public void SetData(int userID, short udpCode, UdpBigDataManager manager)
        {
            this.udpCode = udpCode;
            mUserID = userID;
            mManager = manager;
            dataList = new List<UdpBigDataItem>();
            mTempUdpMsg = ClassPool<UdpMsg>.Pop();
        }
        ...
        public  void Recycle()
        {
            dataList?.Recycle();
            mTempUdpMsg?.Recycle();
            ClassPool<UdpBigData>.Push(this);
        }
